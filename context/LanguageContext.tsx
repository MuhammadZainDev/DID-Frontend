...
const enTranslations = {
  ...
  'settings.prayerNotifications': 'Prayer Notifications',
  'settings.manageNotifications': 'Manage prayer time notifications',
  ...
  'settings.adhanNotifications': 'Adhan and notifications',
...
const urTranslations = {
  ...
  'settings.notifications': 'نوٹیفیکیشنز',
  'settings.theme': 'تھیم',
  ...
  'settings.prayerNotifications': 'نماز کی نوٹیفیکیشنز',
  'settings.manageNotifications': 'نماز کے اوقات کی نوٹیفیکیشنز کا انتظام کریں',
  ...
  'settings.adhanNotifications': 'اذان اور نوٹیفیکیشنز',
